...
# Ensure only one version of pip is ever installed
get_pip_command="/opt/get-pip.py -I --no-index --ignore-installed --find-links=https://mirror.rackspace.com/rackspaceprivatecloud/python_packages/icehouse"
python2 ${get_pip_command} || python ${get_pip_command}
